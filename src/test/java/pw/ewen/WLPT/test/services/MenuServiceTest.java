...
public class MenuServiceTest {
     ...
     * |-menu2
     */
    public void generateLeafMenusTree(){
        List<Menu> leafMenus = new ArrayList<>();
        leafMenus.add(this.menu111);
        leafMenus.add(this.menu112);
        leafMenus.add(this.menu11);
        leafMenus.add(this.menu12);
        leafMenus.add(this.menu2);

        List<Menu> menus = this.menuService.generateLeafMenusTree(leafMenus);
...
//                * |  |   |-menu112
        ...
        assertThat(menus.get(1).getChildren())
                .hasSize(0);
